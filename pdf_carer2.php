...
$query = "SELECT *,
		DATE_FORMAT( start_date,'%d %b %Y') AS start_date, DATE_FORMAT( end_date,'%d %b %Y') AS end_date FROM perfomance_history WHERE id_usuario = $id";
           ...
           <div class=\"row infoRow\" id=\"divJH2\">
			 ...
			 $html.=" 
                ...
                <div class=\"row\">
                  <div class=\"fixColumn date2\"><strong>Degree</strong></div>
				   <div class=\"fixColumn date2\"><strong>Major</strong></div>
				    <div class=\"fixColumn tinyText3\"><strong>Country</strong></div>
			  ...
			  $html.="
				...
				<div class=\"fixColumn3 tinyText3\">{$row['country']}</div>
			...
			<form name=\"formGM\" method=\"post\">
              <div class=\"row topic\">
                ...
                <div class=\"row\" style=\"background:#eeeeee\">
					...
					<div class=\"ancho\">{$rowGM['willing']}</div>
					<div> 
					  {$rowGM['coments']}
					</div>
                      <div>{$rowGM['date']}</div>
...
echo"<script>window.location=\"pdfs/carer_".$id.".pdf\"; parent.cerrarV(); </script>";
